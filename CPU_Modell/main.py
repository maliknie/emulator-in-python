...
mainmemory.setValueAtIndex(byte.Byte().setByte('00001111'), 1)
...
mainmemory.setValueAtIndex(byte.Byte().setByte('00000001'), 101) # Adress small to the value we want to move
mainmemory.setValueAtIndex(byte.Byte().setByte('11111111'), 102) # Address big to the destination
mainmemory.setValueAtIndex(byte.Byte().setByte('00011111'), 103) # Address small to the destination
